...
const ReviewDetails = () => {
    ...
    return (
        <div className="review-bg-home pb-5" id="testimonials">
            <Container>
                <h1 className="section-header fw-bold stylish-front pt-3"> Testimonials </h1>
                <hr className="w-25 mx-auto pb-0 mb-0 " />
                <p className="text-success"> What people think  </p>
